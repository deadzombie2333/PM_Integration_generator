...
**请求地址:** `https://pay-gate-uat.payermax.com/aggregate-pay/api/gateway/capture`
...
| 参数名 | 类型 | 必填 | 说明 | 限制 |
|--------|------|------|------|------|
| requestId | string | 是 | 商户请款请求的唯一id | <= 64 characters |
| outTradeNo | string | 是 | 商户订单号 | <= 64 characters |
| currency | string | 是 | 请款币种 | <= 3 characters |
| amount | number | 是 | 请款金额 | - |
