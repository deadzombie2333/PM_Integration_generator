...
**请求地址:** `https://pay-gate-uat.payermax.com/aggregate-pay/api/gateway/putRfiMaterialList`
...
| 参数名 | 类型 | 必填 | 说明 |
|--------|------|------|------|
| rfiNo | string | 是 | Rfi编码 |
| materialList | array[object] | 是 | RFI关联材料信息列表 |
