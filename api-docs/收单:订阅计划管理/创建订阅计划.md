...
**请求地址:** `https://pay-gate-uat.payermax.com/aggregate-pay/api/gateway/subscriptionCreate`

**接口说明:** PayerMax提供多种类型的订阅计划:普通订阅、n天试用、前n期优惠;可以通过创建订阅计划的入参来控制订阅计划的类型。
...
| callbackUrl | string | 是 | 订阅结果和扣款结果的通知地址 | <= 256 characters |
